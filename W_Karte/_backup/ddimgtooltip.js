var ddimgtooltip={
	...
	tiparray:function(){
		...
		"Dr. Christian Federau, Oberarzt der Neuroradiologie, erhielt<br>einen AMBIZIONE-Grant des SNF zur Erforschung der<br>Hirndurchblutung mit der kontrastmittelfreien, sogenannten<br>IVIM-Methode. Er wurde zudem für seine Publikation (in Radio-<br>logy) zur zeitlichen Evolution von ischämischen<br>Hirnläsionen mit dem Peter Huber Preis 2017 der Schwei-<br>zerischen Gesellschaft für Neuroradiologie ausgezeichnet. "
		,{background:"#f0e4cc", color:"white", opacity: 0.9}]		
		...
		"Die Radiological Society of North America (RSNA) nahm <br> zahlreiche unserer Beiträge für den weltgrössten <br> Radiologiekongress an. Besonders erfreulich ist, dass neben 10 <br> wissenschaftlichen Beiträgen auch 9 Refresherkurse aus <br> Basel kommen. Diese Fortbildungsveranstaltungen <br> widmen sich vornehmlich dem diesjährigen <br> Schwerpunktthema des maschinellen Lernens. Das 3D Print <br> Lab des USB wurde von der RSNA als eine der <br> Institutionen ausgewählt, die ihre Erfahrungen mit dem 3D-<br> Druck vorstellen konnten."
		,{background:"#f0e4cc", color:"white", opacity: 0.9}]		
		...
		"Unsere beiden praxisorientierten Wahlprojekte zur Bildgebung<br>haben gemäss der Evaluation des Studiendekanats<br>den 1. und 3. Platz der Projekte des 3. Bachelors<br>(im Studienjahr 2016/17) belegt. Die Studierenden beurteilen<br>«Praxisnahe Einblicke in die klinische Bildgebung (Radio-<br>logie und Nuklearmedizin)» indes nicht zum ersten Mal<br>so positiv.  Das früher nur einmal angebotene Projekt erreichte schon<br>im Studienjahr 2014/15 den 1. Platz."
		,{background:"#f0e4cc", color:"white", opacity: 0.9}]	
